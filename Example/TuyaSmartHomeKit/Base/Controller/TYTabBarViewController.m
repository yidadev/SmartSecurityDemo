...
@property (nonatomic, strong) TPNavigationController *securityNavigationController;
...
@property (nonatomic, strong) TYSecurityHomeViewController *securityController;
...
- (void)setupControllers {
    ...
    self.viewControllers = @[
                             ...
                             self.securityNavigationController,
...
- (TPNavigationController *)loginNavigationController {
    if (!_loginNavigationController) {
        TYChooseAccountTypeViewController *loginViewController = [TYChooseAccountTypeViewController new];
...
- (TPNavigationController *)securityNavigationController {
    if (!_securityNavigationController) {
        _securityNavigationController = [[TPNavigationController alloc] initWithRootViewController:self.securityController];
    }
    return _securityNavigationController;
}
...
- (TYSecurityHomeViewController *)securityController {
    if (!_securityController) {
        _securityController = [[TYSecurityHomeViewController alloc] init];
        _securityController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Security"
                                                                        image:[UIImage imageNamed:@"ty_security_gray"]
                                                                selectedImage:[UIImage imageNamed:@"ty_security_active"]];
    }
