...
/**
 ...
 @param callback Async result callback. errCode see TuyaErrCode.
 */
- (void)startPlayBackWithStartTime:(int)startTime stopTime:(int)stopTime playTime:(int)playTime onResponse:(void (^)(int errCode))callback onFinish:(void (^)(int errCode))finishedCallBack;
...
/**
 Description Startup sd card playback download.
...
- (void)startPlayBackDownloadWithStartTime:(int)startTime stopTime:(int)stopTime FolderPath:(NSString *)folderPath fileName:(NSString *)fileName onResponse:(void (^)(int errCode))callback onProgress:(void (^)(int errCode, int nPos))progressCallBack onFinish:(void (^)(int errCode))finishedCallBack ;
/**
    pause download
 */
- (void)pausePlayBackDownloadWithResponse:(void (^)(int))callback ;

/**
    resume download
 */
- (void)resumePlayBackDownloadWithResponse:(void (^)(int))callback ;
...
/**
 ...
 @param callback Async result callback. errCode see TuyaErrCode.
 */
- (void)stopPlayBackDownloadWithResponse:(void (^)(int errCode))callback;
